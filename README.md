...
| [FEATURES.md](FEATURES.md) | Complete Claude Code feature reference (60+ settings, 166+ env vars, 26 hooks, 49 plugins) |
| [hooks/](hooks/) | 5 safety hook scripts (copy-paste ready) |
| [skills/](skills/) | 7 skill templates (standup, log, delegate, discuss, verify-work, quick, ops-status) |
| [agents/](agents/) | Agent definition templates with model tiering |
| [statusline.ps1](statusline.ps1) | Custom status line for Windows (model, context %, tokens, cost) |
...
# 6. Edit settings.json (see SETUP.md Step 3)
# 7. Edit ~/.claude/CLAUDE.md with your role (see SETUP.md Step 2)
# 8. Run: claude
```
...
- **Context protocol** — STATE.md (current position), CONTEXT.md (locked decisions), LESSONS.md (self-improvement)
- **Auto-push** — Every commit auto-pushes to remote. No more "did I push?"
...
- **Developers** who want a production-grade Claude Code setup
